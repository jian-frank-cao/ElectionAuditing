...
split_batch = function(data, batch_size_a){
  batches = NULL
  n_a = ceiling(nrow(data)/batch_size_a)
...
#     mutate(
#       temp = LastName_char,
#       LastName_char = FirstName_char,
#       FirstName_char = temp,
#       Initials = paste0(LastName_char1, FirstName_char1),
#       swapped = 1
#     ) %>% 
#     select(-temp)
# )
